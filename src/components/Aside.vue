    ...
    <div class="box-card-body">
      ...
      <div class="text-center">
        ...
        <div class="social">
          ...
          <a data-v-10aff0f3="" href="https://github.com/zjr-2002/vue-bolg-master" title="github"
          ...
          <a data-v-10aff0f3="" href="https://gitee.com/zheng-jianrui/vue-bolg-master" title="码云" target="_blank"><svg
      ...
      <div class="about">
        ...
        <ul>
          <li><i class="el-icon-date"></i>2002-06-25</li>
          <li><i class="el-icon-location-outline"></i>中国·广东</li>
          <li><i class="el-icon-message"></i>2696735300@qq.com</li>
          <li>
